...
class TournamentStorage {
  // upload tournament dp image to storage;
  Future uploadTournamentDp({@required final File imgFile}) async {
    try {
      final _uniqueId = Uuid();
      final _path =
          'tournament_imgs/${DateTime.now().millisecondsSinceEpoch}_${_uniqueId.v1()}';
